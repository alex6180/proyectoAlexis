    ...
    <div>
      ...
      <div className="content-create-user-4">
        <div className="text-create-user-1" onClick={buttonAction}>
          <h1 className="text-btn"> Regresar </h1>
          <img src={Arrow} style={{ width: 20, height: 20 }} />
        </div>
        <div className="circle-create-user-init"></div>
        <div className="circle-second-create-user-init"></div>
        ...
        >
          ...
          <div className="content-button-create-user-3">
            <button
              className={
                form.stepThree === "true"
                  ? "button-create-user2-step-Three"
                  : "button-create-user2-step-two-false"
              }
      ...
      {visibleModal && (
        <div className="content-modal">
          ...
          <p className="button-modal-step-one" onClick={handleButtonModal}>
            Aceptar
          </p>
        </div>
      )}
